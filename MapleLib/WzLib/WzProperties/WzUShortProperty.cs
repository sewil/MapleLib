...
namespace MapleLib.WzLib.WzProperties
{
	...
	/// </summary>
	public class WzUShortProperty : WzImageProperty
	{
		#region Fields
        ...
        {
            WzUShortProperty clone = new WzUShortProperty(name, val);
            return clone;
        }
		...
		public WzUShortProperty(string name, ushort value)
		{
			this.name = name;
			this.val = value;
		}
